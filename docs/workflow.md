...
`api route -> service -> repository -> schema/types -> client fetcher -> UI hook -> feature component`
...
- UI data hook: `src/hooks/use-<resource>.ts`
...
5. Implement frontend API caller + hook.
